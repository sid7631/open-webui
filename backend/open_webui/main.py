...
app.state.config.ENABLE_IMAGE_CAPTION_GENERATION = ENABLE_IMAGE_CAPTION_GENERATION

app.state.config.DEFAULT_IMAGE_CAPTION_MODEL = DEFAULT_IMAGE_CAPTION_MODEL
app.state.config.IMAGE_CAPTION_PROMPT_TEMPLATE = IMAGE_CAPTION_PROMPT_TEMPLATE
